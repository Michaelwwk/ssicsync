...
from main import group, ssic_alpha_index_filepath, ssic_detailed_def_filepath
...
st.header(f'👥 Group, {group} Categories', divider='rainbow')
...
with col2:
    ...
    if ssic_2020_title_filter:
        filtered_df_ref = filtered_df_ref[filtered_df_ref['Group Title'].str.contains(ssic_2020_title_filter, case=False)]
    else:

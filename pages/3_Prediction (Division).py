...
from main import topN, division, ssic_alpha_index_filepath, ssic_detailed_def_filepath
...
with col1:
    ...
    st.write(f"""
    ##### Classification ({division} Division Categories)
    Welcome to the Business Description Classifier! This application utilizes a multi-class text classification model 
    to categorize business descriptions into one of {division} Division categories. Simply input your business description, 
...
with col2:
    ...
    classifying a wide range of business activities. The {division} Division categories cover various industry sectors, 

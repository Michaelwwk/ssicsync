...
# from commonFunctions import ssic_df # TODO REINSTATE!
...
DoS = pd.read_csv("C:/Users/Michael/Documents/GitHub/ssicsync/dataSources/ScrapedOutputFiles/list of 90 Coy and SSIC.csv")
modelOutputs = pd.read_csv("C:/Users/Michael/Documents/GitHub/ssicsync/models/classificationModel/modelOutputFiles/pdfModelFinalOutputs.csv", dtype={'ssic_code': str, 'ssic_code2': str})

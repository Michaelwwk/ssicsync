...
def validatingClassificationModel(self):
    ...
    # export dataframes to csv in modelOutputFiles folder

    ssic_1.to_csv('modelOutputFiles\ssic_1.csv', index=False) 
    ssic_2.to_csv('modelOutputFiles\ssic_2.csv', index=False)
    ssic_3.to_csv('modelOutputFiles\ssic_3.csv', index=False)
    ssic_4.to_csv('modelOutputFiles\ssic_4.csv', index=False)
    ssic_5.to_csv('modelOutputFiles\ssic_5.csv', index=False)
    ssic_df.to_csv('modelOutputFiles\ssic_df.csv', index=False)
